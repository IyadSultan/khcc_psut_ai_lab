            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {% if request.resolver_match.url_name == 'submit_project' and request.resolver_match.namespace == 'projects' %}active{% endif %}" 
                       href="{% url 'projects:submit_project' %}">Share Seed</a>
                </li>
                {% endif %}
            </ul>
            <ul class="navbar-nav">
...
{% block title %}Edit {{ project.title }} - KHCC_PSUT AI Lab{% endblock %}
...
{% block title %}Analytics for {{ project.title }} - KHCC_PSUT AI Lab{% endblock %}
        ...
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{% url 'projects:submit_project' %}" class="btn btn-primary">
                    <i class="bi bi-plus-lg"></i> Share Seed
                </a>
                {% endif %}
            </div>
